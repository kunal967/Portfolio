...
const About = () => {
  return (
    <div className="h-max sm:h-screen relative top-4 sm:top-8  bg-home">
      <div className="mr-3 ml-3">
        ...
        <div className="flex flex-col sm:grid gap-10 grid-cols-2">
          <div className=" text-home bg-navbar rounded-lg p-8 text-left">
            ...
            <span className="font-portfolio text-xl ">
          ...
          <div className="text-purple-600 bg-navbar rounded-lg p-4 text-left mb-10">
            {/* my skills */}
            <span className="font-bold text-nav-text text-4xl block text-start pb-6">
              My Skills
            </span>
            <div className="flex flex-wrap overflow-hidden text-xl">
