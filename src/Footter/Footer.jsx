...
const Footer = () => {
 ...
 const onClickMail =() =>{
  ...
  return (
    <div className="w-screen flex h-32 text-center bg-navbar relative top-20 ">
      <footer className=" flex justify-around items-center w-full">
        <div className="text-left w-2/4 text-home">
          <div>Kunal Takalkar</div>
          <div>A Frontend focused Web Developer building the Frontend of Websites and
          Web Applications  that leads to the success of the overall
          product</div>
        </div>
        <div className="flex text-home">
          
          <div className="px-4 h-auto w-auto cursor-pointer">
            <ion-icon onClick={onClickMail} name="mail-outline"/>   
          </div>
          <div className="px-4 h-auto w-auto cursor-pointer">
            <ion-icon onClick={onClickGit} name="logo-github"/>   
          </div>
          <div className="px-4 h-auto w-auto cursor-pointer">
            <ion-icon onClick={onClickLinkdin} name="logo-linkedin"/>   
          </div>
